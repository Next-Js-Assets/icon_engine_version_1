...
import Home from "./SubPanels/Home/Home";
import ManageAdminUsers from "./SubPanels/ManageAdminUsers/ManageAdminUsers";
import ManageUsers from "./SubPanels/ManageUsers/ManageUsers";
import ManageDesigns from "./SubPanels/ManageDesigns/ManageDesigns";
import ManageIllustrations from "./SubPanels/ManageIllustrations/ManageIllustrations";
import Settings from "./SubPanels/Settings/Settings";
import Profile from "./SubPanels/Profile/Profile";
import ProfileSettings from "./SubPanels/ProfileSettings/ProfileSettings";
...
export default function Example() {
  ...
  const [navigation, setNavigation] = useState([
    ...
    { name: MANAGE_DESIGNS, icon: ClockIcon, current: true },
  ...
  const handelSideBarOption = (value) => {
    switch (value) {
      case HOME:
           setCurrentOpenPanelTitle("Over view");
  ...
  return (
    <div className="relative h-screen flex overflow-hidden bg-gray-100">
      ...
      <div className="flex-1 overflow-auto focus:outline-none">
        <div className="relative z-10 flex-shrink-0 flex h-16 bg-white  lg:border-none">
          <button
            type="button"
